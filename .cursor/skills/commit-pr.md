...
# before anything - check if this issue exists on github board. if not then create a issue and issue description on github for this repo and then follow the rest
